...
class InvestmentPropertieController extends Controller
{
    /**
    ...
    {
        $propertie = InvestmentPropertie::orderBy('id', 'desc')->with('propertyType')->get();
        return view('admin.investment_propertie.propertie', compact('propertie'));
     }
    ...
    public function create()
    {
        ...
        return view('admin.investment_propertie.create',compact('propertyTypes','amenitie','agents'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $property->save();
        return redirect()->route('investment_properties.index')->with('success', 'Property created successfully!');
    ...
    public function edit($id)
    {
        ...
        return view('admin.investment_propertie.edit', compact('property','propertyTypes','agents','amenitie'));
    }
