...
class PrivatePropertieController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $propertie = PrivatePropertie::orderBy('id', 'desc')->with('propertyType')->get();
        return view('admin.private_propertie.propertie', compact('propertie'));
     }
    ...
    public function create()
    {
        ...
        return view('admin.private_propertie.create',compact('propertyTypes','amenitie','agents'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $property->save();
        return redirect()->route('private_properties.index')->with('success', 'Property created successfully!');
    ...
    public function edit($id)
    {
        ...
        return view('admin.private_propertie.edit', compact('property','propertyTypes','agents','amenitie'));
    }
