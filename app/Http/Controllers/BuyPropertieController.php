...
class BuyPropertieController extends Controller
{
    ...
    public function __construct()
    {
     ...
     public function index()
        {
            $propertie = BuyPropertie::orderBy('id', 'desc')->with('propertyType')->get();
            return view('admin.buy_propertie.propertie', compact('propertie'));
        }
        ...
        $amenitie = Amenitie::where('status','1')->get();
            return view('admin.buy_propertie.create',compact('propertyTypes','agents','amenitie'));
        }
        ...
        public function edit($id)
        {
	        ...
	        $agents = Agent::all();
	        $amenitie = Amenitie::where('status','1')->get();
            return view('admin.buy_propertie.edit', compact('property','propertyTypes','agents','amenitie'));
        }
