                ...
                <div class="row row-container-section pl-2 pr-2">
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" accept="image/*" name="section_1_image" id="section_1_image" class="form-control">
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="section_2_image_1">Section 2 Image 1</label>
                                    <input type="file"  accept="image/*" name="section_2_image_1" id="section_2_image_1" class="form-control">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="file" accept="image/*" name="section_2_image_2" id="section_2_image_2" class="form-control">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="file" accept="image/*" name="section_2_image_3" id="section_2_image_3" class="form-control">
                                </div>
                                <div class="form-group">
