                    ...
                    <div class="col-lg-7 mx-auto">
                        <div class="accordion" id="accordionExample">
                            ...
                            @php $count = $count+1; @endphp
                                <div class="card">
                                    <div class="card-header" id="headingOne{{$count}}"> <h2 class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseOne{{$count}}" aria-expanded="{{ ($count != 1) ? 'false':'true' }}" aria-controls="collapseOne{{$count}}"> {{$question->question}} </h2> </div>
