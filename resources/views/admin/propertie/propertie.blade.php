...
@section('content')
    <section>
        <p class="heading_for_admin_section">Add Properties 
            <a class="add_new_button m-0" href="{{ route('properties.create') }}">+ Add New Property</a>
            <a class="add_new_button  m-0" href="{{ route('property-type.create','master') }}">+ Add Property Type</a></p>
            ...
            <tbody>
                @if(isset($propertie) && !empty($propertie) && count($propertie))
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="edit_button" href="{{ route('properties.edit', $item) }}">
                                <i class="fa-solid fa-pencil"></i>
                            </a>
                            <form action="{{ route('properties.destroy', $item) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
