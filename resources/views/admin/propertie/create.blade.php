...
@section('content')
    ...
    <section>
    	...
    	<div class="section_content">
    		<form id="image-upload-form" action="{{ route('properties.store') }}" method="POST" enctype="multipart/form-data">
    			 @csrf
        ...
        <div class="form-group">
            ...
            @enderror
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" name="bed" id="bed" value="1" {{ old('bed') ? 'checked' : '' }}>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                <label for="category_id">Property Type <span class="mandatory">*</span> <span class="help_url"><a href="{{ route('property-type.create','master') }}" target="_blank">Add Property Type</a></label>
