...
@section('content')
    ...
    <section>
        ...
        <div class="section_content">
            <form id="image-upload-form" action="{{ route('international_properties.update', $property->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
               ...
               <div class="col-12">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        <label for="category_id">Property Type  <span class="help_url"><a href="{{ route('property-type.create', 'international') }}" target="_blank">Add Property Type</a></span></label>
