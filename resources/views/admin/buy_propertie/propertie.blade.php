...
@endif
    <section>
        <p class="heading_for_admin_section">Add Buy Properties 
            <a class="add_new_button m-0" href="{{ route('buy_properties.create') }}">+ Add New Property</a>
            <a class="add_new_button  m-0" href="{{ route('property-type.create','buy') }}">+ Add Property Type</a></p>
                ...
                @if(isset($propertie) && !empty($propertie) && count($propertie))
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @endif
                            <a class="edit_button" href="{{ route('buy_properties.edit', $item) }}">
                                <i class="fa-solid fa-pencil"></i>
                            </a>
                            <form action="{{ route('buy_properties.destroy', $item) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
