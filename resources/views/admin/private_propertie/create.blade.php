...
@section('content')
    ...
    <section>
    	...
    	<div class="section_content">
    		<form id="image-upload-form" action="{{ route('private_properties.store') }}" method="POST" enctype="multipart/form-data">
    			 @csrf
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                <label for="category_id">Property Type <span class="mandatory">*</span> <span class="help_url"><a href="{{ route('property-type.create','private') }}" target="_blank">Add Property Type</a></label>
