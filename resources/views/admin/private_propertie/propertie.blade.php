...
@section('content')
    ...
    @endif
    <section>
        <p class="heading_for_admin_section">Add Private Properties 
            <a class="add_new_button m-0" href="{{ route('private_properties.create') }}">+ Add New Property</a>
            <a class="add_new_button  m-0" href="{{ route('property-type.create','private') }}">+ Add Property Type</a></p>
