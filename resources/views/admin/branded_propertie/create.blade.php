...
@section('content')
    ...
    @endif
    <section>
        <p class="heading_for_admin_section">New Branded Properties</p>
        <div class="section_content">
            <form id="image-upload-form" action="{{ route('branded_properties.store') }}" method="POST"
    ...
    @enderror -->
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                <label for="category_id">Property Type  <span class="help_url"><a href="{{ route('property-type.create','branded') }}" target="_blank">Add Property Type</a></label>
