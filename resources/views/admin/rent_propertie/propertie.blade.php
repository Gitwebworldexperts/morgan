...
@endif
    <section>
        <p class="heading_for_admin_section">Add Rent Properties 
            <a class="add_new_button m-0" href="{{ route('rent_properties.create') }}">+ Add New Property</a>
            <a class="add_new_button  m-0" href="{{ route('property-type.create','rent') }}">+ Add Property Type</a></p>
            ...
            <tbody>
                @if(isset($propertie) && !empty($propertie) && count($propertie))
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="edit_button" href="{{ route('rent_properties.edit', $item) }}">
                                <i class="fa-solid fa-pencil"></i>
                            </a>
                            <form action="{{ route('rent_properties.destroy', $item) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
