...
@section('title', 'Pages: Rent Properties')
@section('content')
    @if ($errors->any())
    ...
    @endif
    <section>
    	<p class="heading_for_admin_section">New Rent Properties</p>
    	<div class="section_content">
    		<form id="image-upload-form" action="{{ route('rent_properties.store') }}" method="POST" enctype="multipart/form-data">
    			 @csrf
    ...
    @enderror -->
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                <label for="category_id">Property Type  <span class="help_url"><a href="{{ route('property-type.create','rent') }}" target="_blank">Add Property Type</a></label>
