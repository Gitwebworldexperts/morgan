...
@section('content')
    ...
    @endif
    <section>
    	<p class="heading_for_admin_section">New Project Properties</p>
    	<div class="section_content">
    		<form id="image-upload-form" action="{{ route('project_properties.store') }}" method="POST" enctype="multipart/form-data">
    			 @csrf
    ...
    @enderror -->
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                <label for="category_id">Property Type <span class="mandatory">*</span> <span class="help_url"><a href="{{ route('property-type.create','project') }}" target="_blank">Add Property Type</a></label>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        <label for="company_id">Company<span class="mandatory">*</span> <span class="help_url"><a href="{{ route('companies.index') }}" target="_blank">Add Company</a></label>
                        <select class="form-control" name="company_id" id="company_id">
                            <option value="">Select an Company</option>
                            @if ($companies)
                                @foreach ($companies as $item)
                                    <option value="{{ $item->id }}"
                                        {{ old('company_id') == $item->id ? 'selected' : '' }}>{{ $item->company_name }}
                                    </option>
                                @endforeach
                            @endif
                        </select>
                    ...
                    <div class="col-12">
                        {!! getButtonUrl('compnay_listing', old('compnay_listing'), old('compnay_listing_2'), '') !!}
                    </div>
                </div>
