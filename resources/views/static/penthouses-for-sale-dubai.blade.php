@extends('layouts.app')
@php
$global = Config::get('static_meta.penthouses-for-sale-dubai', []);
$meta_title = $global[0] ?? '';
$meta_description = $global[1] ?? '';
@endphp

@section('title', $meta_title ?: 'Penthouses For Sale Dubai')
...
<section class="banner inr-banner mb-4" style="background-image: url({{ asset('/img/inr-banner.png') }});">
    ...
    <div class="container mb-4">
        <div class="row">
            <div class="col-12">
            <h1>
                <strong>Redefine the Pinnacle of Luxury Living with Penthouses in Dubai!</strong>
            </h1>
            <p>
            ...
            <h2>
                <strong>Penthouses in Dubai are where your Story Begins&nbsp;</strong>
            </h2>
            <p>
            ...
            <h2>
                <strong>Penthouses that are Close to the Natural Elements</strong>
            </h2>
            <p>
            ...
            <h2>
                <strong>Make your Quintessential Dubai Dream a Reality&nbsp;</strong>
            </h2>
            <p>
            ...
            <h2>
                <strong>Our Penthouses are the Crown Jewels of Apartment Living&nbsp;</strong>
            </h2>
            <p>
            ...
            <h2>
                <strong>Stunning Bespoke Penthouse Apartments Overlooking the Sea&nbsp;</strong>
            </h2>
            <p>
            ...
            <h2>
                <strong>The Integral Features of our Penthouses for Sale</strong>
            </h2>
            <p>
            ...
            <h2>
                <strong>Purchase Penthouse in a City that Offers One of the Best Living Standards&nbsp;</strong>
            </h2>
            <p>
            ...
            <h2>
                <strong>Be the Proud Owner of a Penthouse in Dubai Marina&nbsp;</strong>
            </h2>
            <p>
            ...
            <h2>
                <strong>A Prestigious Status Symbol for Homeowners&nbsp;</strong>
            </h2>
            <p>
